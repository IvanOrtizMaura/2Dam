...
public class ListaIncidenciasController implements Initializable {
    @FXML
    private Pane panel;
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
        ...
        actualizarTabla("SELECT * FROM tim.incidencias");
    ...
    private void actualizarTabla(String query) {
        try (PreparedStatement statement = App.conexion.prepareStatement(query);
            ...
            while (rs.next()) {
                Label lbl = new Label(rs.getString("titulo"));
                lbl.setLayoutX(80);
                lbl.setLayoutY(rLblY);
                ...
                Pane p = new Pane();
                Image img = new Image(getClass().getResourceAsStream("fotos/advertencia.png"));
